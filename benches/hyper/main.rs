...
// #[path = "../benches/support/mod.rs"] EDIT:"no need":EDIT
mod support;
...
pub async fn main() -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    ...
    let addr: SocketAddr = ([127, 0, 0, 1], 8080).into(); // EDIT:"needed for testing":EDIT
    ...
    loop {
        ...
        tokio::task::spawn(async move {
            ...
            if let Err(err) = http1::Builder::new()
                ...
                .await
            {
                eprintln!("Error serving connection: {:?}", err); // EDIT:"needed for testing":EDIT
            }
        });
    }
}
